...
function orderFilter(getPos: (arg: number, n: number) => number) {
	return immediate({
		filterEq(regions: RegionList, arg: number, _0: CourseData, _1: HorseParameters, extra: RaceParameters) {
			return [regions, (s: RaceState) => s.currentRank == getPos(arg, extra.numUmas)] as [RegionList, DynamicCondition];
		},
...
function orderInFilter(rate: number) {
	return immediate({
		filterEq(regions: RegionList, one: number, _0: CourseData, _1: HorseParameters, extra: RaceParameters) {
			...
			return [regions, (s: RaceState) => s.currentRank <= Math.round(rate * extra.numUmas)] as [RegionList, DynamicCondition];
		}
	});
}
...
export const Conditions: {[cond: string]: Condition} = Object.freeze({
	...
	compete_fight_count: immediate({
		filterGt(regions: RegionList, _0: number, course: CourseData, _1: HorseParameters, extra: RaceParameters) {
			...
			return [regions.rmap(r => r.intersect(lastStraight)), (s: RaceState) => s.isCompeting] as [RegionList, DynamicCondition];
		}
	}),
	corner: immediate({
	...
	is_move_lane: immediate({
		filterEq(regions: RegionList, flag: number, _0: CourseData, _1: HorseParameters, extra: RaceParameters) {
			return [regions, (s: RaceState) => s.isOvertaking] as [RegionList, DynamicCondition]; // approximated as overtaking
		}
	}),
	is_overtake: immediate({
		filterEq(regions: RegionList, flag: number, _0: CourseData, _1: HorseParameters, extra: RaceParameters) {
			return [regions, (s: RaceState) => s.isOvertaking] as [RegionList, DynamicCondition];
		}
	}),
	is_surrounded: immediate({
		filterEq(regions: RegionList, flag: number, _0: CourseData, _1: HorseParameters, extra: RaceParameters) {
			return [regions, (s: RaceState) => s.isCompeting] as [RegionList, DynamicCondition];
		}
	}),
	...
	near_count: immediate({
		filterGte(regions: RegionList, val: number, _0: CourseData, _1: HorseParameters, extra: RaceParameters) {
			return [regions, (s: RaceState) => (s.isCompeting ? 1 : 0) >= val] as [RegionList, DynamicCondition];
		},
		filterGt(regions: RegionList, val: number, _0: CourseData, _1: HorseParameters, extra: RaceParameters) {
			return [regions, (s: RaceState) => (s.isCompeting ? 1 : 0) > val] as [RegionList, DynamicCondition];
		},
		filterLte(regions: RegionList, val: number, _0: CourseData, _1: HorseParameters, extra: RaceParameters) {
			return [regions, (s: RaceState) => (s.isCompeting ? 1 : 0) <= val] as [RegionList, DynamicCondition];
		},
		filterLt(regions: RegionList, val: number, _0: CourseData, _1: HorseParameters, extra: RaceParameters) {
			return [regions, (s: RaceState) => (s.isCompeting ? 1 : 0) < val] as [RegionList, DynamicCondition];
		},
		filterEq(regions: RegionList, val: number, _0: CourseData, _1: HorseParameters, extra: RaceParameters) {
			return [regions, (s: RaceState) => (s.isCompeting ? 1 : 0) == val] as [RegionList, DynamicCondition];
		}
	}),
	...
	overtake_target_no_order_up_time: immediate({
		filterEq(regions: RegionList, flag: number, _0: CourseData, _1: HorseParameters, extra: RaceParameters) {
			return [regions, (s: RaceState) => s.isOvertaking] as [RegionList, DynamicCondition];
		}
	}),
	overtake_target_time: immediate({
		filterEq(regions: RegionList, flag: number, _0: CourseData, _1: HorseParameters, extra: RaceParameters) {
			return [regions, (s: RaceState) => s.isOvertaking] as [RegionList, DynamicCondition];
		}
	}),
